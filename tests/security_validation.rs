...
mod security_validation_tests {
    ...
    fn test_system_resource_detection() {
        ...
        let params1 = Argon2Params::production_params();
        let params2 = Argon2Params::production_params();
        ...
        let custom = Argon2Params::custom(2048, 3, 2);
    ...
    fn test_key_derivation_with_adaptive_params() {
        ...
        let params = Argon2Params::test_params(); // Use fast test params
